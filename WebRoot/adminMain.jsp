...
<div class="layui-layout layui-layout-admin"> <!-- 添加skin-1类可手动修改主题为纯白，添加skin-2类可手动修改主题为蓝白 -->
    ...
    <div class="layui-header my-header">
        ...
        <ul class="layui-nav my-header-user-nav" lay-filter="side-top-right">
            ...
            <li class="layui-nav-item">
                <a class="name" href="javascript:;"><img src="./frame/static/image/code.png" alt="logo"><%=adminName %></a>
                <dl class="layui-nav-child">
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="side-main">
               <li class="layui-nav-item  layui-nav-itemed">
                ...
                <li class="layui-nav-item">
                    <a href="javascript:;"><i class="layui-icon">&#xe621;</i>管理员信息</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" href-url="admin/user.jsp"><i class="layui-icon">&#xe621;</i>管理员信息</a></dd>
                    </dl>
                </li>
            </ul>
