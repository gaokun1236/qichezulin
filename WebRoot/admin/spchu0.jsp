...
var url;
	...
	function openSpchuAddDialog(){
		$("#dlg").dialog("open").dialog("setTitle","添加尚未付款");
		url="../addSpchu";
	}
	...
	function openSpchuModifyDialog(){
		...
		$("#dlg").dialog("open").dialog("setTitle","编辑尚未付款");
		$("#fm").form("load",row);
	...
	function daoruSpchus(){
		$("#daoru").dialog("open").dialog("setTitle","导入尚未付款");
		daoruurl="../daoruSpchu";
	}
	...
	function shangchuanSpchu(){
		...
		var row=selectedRows[0];
		$("#shangchuan").dialog("open").dialog("setTitle","上传尚未付款");
...
<!--startprint-->
	<table id="dg" title="尚未付款" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getSpchus?spchuType=0" fit="true" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="tb" hidden="true">
		...
		&nbsp;管理员：&nbsp;<input class="easyui-combobox" id="s_userId" name="s_userId"  data-options="panelHeight:'auto',editable:false,valueField:'userId',textField:'userName',url:'../userComboList'"/>
