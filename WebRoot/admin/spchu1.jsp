...
var url;
	...
	function openSpchuAddDialog(){
		$("#dlg").dialog("open").dialog("setTitle","添加租赁评价");
		url="../addSpchu";
	}
	...
	function openSpchuModifyDialog(){
		...
		$("#dlg").dialog("open").dialog("setTitle","编辑租赁评价");
		$("#fm").form("load",row);
	...
	function daoruSpchus(){
		$("#daoru").dialog("open").dialog("setTitle","导入租赁评价");
		daoruurl="../daoruSpchu";
	}
	...
	function shangchuanSpchu(){
		...
		var row=selectedRows[0];
		$("#shangchuan").dialog("open").dialog("setTitle","上传租赁评价");
...
<!--startprint-->
	<table id="dg" title="租赁评价" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getSpchus?spchuType=1" fit="true" toolbar="#tb">
		<thead>
			<tr>
