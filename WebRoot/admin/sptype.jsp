...
<script type="text/javascript">
	...
	function openSptypeAddDialog(){
		$("#dlg").dialog("open").dialog("setTitle","添加汽车品牌");
		url="../addSptype";
	}
	...
	function openSptypeModifyDialog(){
		...
		$("#dlg").dialog("open").dialog("setTitle","编辑汽车品牌");
		$("#fm").form("load",row);
...
<body style="margin: 5px;">
	<table id="dg" title="汽车品牌" class="easyui-datagrid" fitColumns="true"
	...
	<div id="tb">
		<div>
			<a href="javascript:openSptypeAddDialog()" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加</a>
			<a href="javascript:openSptypeModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">修改</a>
			<a href="javascript:deleteSptype()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">删除</a>
		</div>
	</div>
