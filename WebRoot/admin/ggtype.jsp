...
<script type="text/javascript">
	...
	function openGgtypeAddDialog(){
		$("#dlg").dialog("open").dialog("setTitle","添加公告类型");
		url="../addGgtype";
	}
	...
	function openGgtypeModifyDialog(){
		...
		$("#dlg").dialog("open").dialog("setTitle","编辑公告类型");
		$("#fm").form("load",row);
...
<body style="margin: 5px;">
	<table id="dg" title="公告类型" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getGgtypes" fit="true" toolbar="#tb">
		<thead>
			<tr>
				<th field="cb" checkbox="true"></th>
				<th field="ggtypeId" width="20">编号</th>
