...
<div class="layui-layout layui-layout-admin"> <!-- 添加skin-1类可手动修改主题为纯白，添加skin-2类可手动修改主题为蓝白 -->
    ...
    <div class="layui-header my-header">
        ...
        <ul class="layui-nav my-header-user-nav" lay-filter="side-top-right">
            ...
            <li class="layui-nav-item">
                <a class="name" href="javascript:;"><img src="./frame/static/image/code.png" alt="logo"><%=yonghuXingming %></a>
                <dl class="layui-nav-child">
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="side-main">
               <li class="layui-nav-item  layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" href-url="yonghu/gonggao.jsp"><i class="layui-icon">&#xe621;</i>公告信息</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;"><i class="layui-icon">&#xe621;</i>个人信息</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" href-url="yonghu/yonghu.jsp"><i class="layui-icon">&#xe621;</i>个人信息</a></dd>
                        <dd><a href="javascript:;" href-url="yonghumima.jsp"><i class="layui-icon">&#xe621;</i>修改密码</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;"><i class="layui-icon">&#xe622;</i>汽车信息</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" href-url="yonghu/shangpin.jsp"><i class="layui-icon">&#xe621;</i>汽车信息</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;"><i class="layui-icon">&#xe622;</i>租赁信息</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" href-url="yonghu/spchu0.jsp"><i class="layui-icon">&#xe621;</i>等待租赁</a></dd>
                        <dd><a href="javascript:;" href-url="yonghu/spchu1.jsp"><i class="layui-icon">&#xe621;</i>租赁信息</a></dd>
                         <!-- <dd><a href="javascript:;" href-url="yonghu/spchu2.jsp"><i class="layui-icon">&#xe621;</i>还车信息</a></dd> -->
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;"><i class="layui-icon">&#xe622;</i>留言信息</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" href-url="yonghu/yxinxi.jsp"><i class="layui-icon">&#xe621;</i>留言信息</a></dd>
                    </dl>
                </li>
            </ul>
