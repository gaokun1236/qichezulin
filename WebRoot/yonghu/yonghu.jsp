...
<!--startprint-->
	<table id="dg" title="用户信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getYonghus?yonghuId=<%=yonghuId %>" fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="yonghuMark1" width="40">支付</th>
				<th field="yonghuYue" width="20">余额</th>
				<th field="yonghuXiaofei" width="20">消费</th>
				<th field="yonghuDate1" width="40" formatter="datetostr">时间</th>
			</tr>
		</thead>
	</table>
