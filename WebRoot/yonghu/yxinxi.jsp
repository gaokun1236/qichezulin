...
var yonghuId = <%=yonghuId%>;
	function searchYxinxi(){
		$('#dg').datagrid('load',{
			...
			byumenId:$('#s_byumenId').combobox("getValue"),
	...
	function openYxinxiAddDialog(){
		...
		url="../addYxinxi?yonghuId="+yonghuId;
	}
...
<!--startprint-->
	<table id="dg" title="留言信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getYxinxis?yonghuId=<%=yonghuId %>" fit="true" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="dlg" class="easyui-dialog" style="width: 380px;height: 260px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table>
				...
				<tr>
					<td valign="top">描述：</td>
					<td><textarea rows="7" cols="30" name="yxinxiMark" id="yxinxiMark"></textarea></td>
				</tr>
			</table>
		</form>
	</div>
