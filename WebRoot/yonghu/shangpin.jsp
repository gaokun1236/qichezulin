...
var yonghuId = <%=yonghuId%>;
	...
	function openShangpinModifyDialog(){
		...
		$("#fm").form("load",row);
		url="../addSpchu?shangpinId="+row.shangpinId+"&yonghuId="+yonghuId;
	}
...
<!--startprint-->
	<table id="dg" title="汽车信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getShangpins" fit="true" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="tb">
		<div>
			<a href="javascript:openShangpinModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">租赁</a>
		</div>
		<div>
		&nbsp;车牌：&nbsp;<input type="text" name="s_shangpinName" id="s_shangpinName" size="10"/>
