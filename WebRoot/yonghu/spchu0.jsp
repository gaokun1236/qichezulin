...
var yonghuId = <%=yonghuId%>;
	...
	function openSpchuModifyDialog(){
		...
		$("#fm").form("load",row);
		url="../addSpchu?spchuType=1&spchuId="+row.spchuId;
	}
	...
	function shenheSpchu(){
		...
		$.messager.confirm("系统提示","您确认要租赁吗？",function(r){
			if(r){
...
<!--startprint-->
	<table id="dg" title="租赁信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getSpchus?spchuType=0&yonghuId=<%=yonghuId %>" fit="true" toolbar="#tb">
		<thead>
			<tr>
...
<!--endprint-->
	<div id="dlg" class="easyui-dialog" style="width: 300px;height: 140px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				<tr>
					<td>支付：</td>
					<td><input type="password" name="spchuMark3" id="spchuMark3" class="easyui-validatebox" required="true"/></td>
				</tr>
			</table>
		</form>
	</div>
	...
	<div id="dlg-buttons">
		<a href="javascript:saveSpchu()" class="easyui-linkbutton" iconCls="icon-ok">确认</a>
